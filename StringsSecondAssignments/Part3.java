...
public class Part3 {
    ...
    public void testCountGenes(){
        String dna1 = "ATGTAAATGCCCTGA";
        String dna2 = "GGATGCCCTAAGG";
        String dna3 = "GATGCCCTAATAGGGTGA";
        String dna4 = "GAATGCC";
        String dna5 = "AATGCTAACTAGCTGACTAAT";
        System.out.println("dna1 : " + countGenes(dna1));
        System.out.println("dna2 : " + countGenes(dna2));
        System.out.println("dna3 : " + countGenes(dna3));
        System.out.println("dna4 : " + countGenes(dna4)); 
        System.out.println("dna5 : " + countGenes(dna5));
    }
}
